...
CREATE TABLE ADMINISTRARIAK OF ADMINISTRARI_TYP
    NESTED TABLE TELEFONOAK STORE AS ADMIN_TELEFONOAK_TAB;
/

CREATE TABLE TEKNIKARIAK OF TEKNIKARI_TYP
    NESTED TABLE TELEFONOAK STORE AS TEK_TELEFONOAK_TAB;
/
...
BEGIN
    DBMS_OUTPUT.PUT_LINE('--- LANGILE GUZTIEN INFORMAZIOA ---');
    DBMS_OUTPUT.PUT_LINE(' ');
    FOR V_REC IN C_LANGILE LOOP
        V_LANGILE := V_REC.EMP;
